...
class Command(BaseCommand):
    help = 'Backfill Chile identity document_number from Didit personal_number (RUN/RUT).'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(
            f'Chile RUT backfill complete. updated={updated} skipped={skipped} dry_run={dry_run}'
        ))
