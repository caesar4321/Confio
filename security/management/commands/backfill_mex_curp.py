...
class Command(BaseCommand):
    help = 'Backfill Mexico identity document_number from Didit personal_number (CURP).'
    ...
    def handle(self, *args, **options):
        ...
        for verification in queryset.iterator():
            ...
            if verification.document_number == personal_number:
                skipped += 1
                continue
            ...
            self.stdout.write(
                ...
                f'{verification.document_number!r} -> {personal_number!r}'
            )
            ...
            if not dry_run:
                ...
                verification.save(update_fields=['document_number', 'document_number_normalized', 'updated_at'])

            updated += 1

        self.stdout.write(self.style.SUCCESS(
            f'Mexico CURP backfill complete. updated={updated} skipped={skipped} dry_run={dry_run}'
        ))
