data = {
	"en": {
		"articles": [
			...
			{
				"header": "3. Why Venezuela and Argentina? Why not countries with a higher crypto adoption rate?",
				"paragraphs": [
					"We reviewed what factors would be the most critical to cryptocurrency mass adoption, and we concluded that, at the moment, an inflation rate would be a much more critical factor than a cryptocurrency adoption rate."
				]
			},
			{
			...
			{
				"header": "6. Why Did Julian Rebrand Duende to Confío?",
				"paragraphs": [
					"Julian wanted to give a fresh atmosphere to start all over Duende from the beginning with a new mindset, new plans and roadmaps, and new tokenomics. Confío means 'I trust' in Spanish."
				]
			},
			{
				"header": "7. What Was Julian's Biggest Mistake In His Opinion?",
				"paragraphs": [
					"Neglecting the power of a community."
				]
			},
			{
