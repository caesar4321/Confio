            ...
            try {
                ...
                const zkLoginInputs = bcs_1.bcs.struct('ZkLoginInputs', {
                    proofPoints: bcs_1.bcs.struct('ProofPoints', {
                        a: bcs_1.bcs.vector(bcs_1.bcs.fixedArray(32, bcs_1.bcs.u8())), // Vector of 32-byte arrays
                        b: bcs_1.bcs.vector(bcs_1.bcs.vector(bcs_1.bcs.fixedArray(32, bcs_1.bcs.u8()))), // Vector of vectors
                        c: bcs_1.bcs.vector(bcs_1.bcs.fixedArray(32, bcs_1.bcs.u8())) // Vector of 32-byte arrays
                    }),
