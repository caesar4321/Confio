...
algod_token = ""
admin_mnemonic = "congress jaguar goose lock banner siege close limit leader mule hope anxiety judge render control whip carry tape pupil coin seek dawn then absent prize"
