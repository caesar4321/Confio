...
class NotificationTypeEnum(graphene.Enum):
    ...
    RAMP_PROCESSING = 'RAMP_PROCESSING'
    RAMP_COMPLETED = 'RAMP_COMPLETED'
    RAMP_FAILED = 'RAMP_FAILED'
    ...
    # Referrals
    REFERRAL_FRIEND_JOINED = 'REFERRAL_FRIEND_JOINED'
    REFERRAL_FIRST_TRANSACTION = 'REFERRAL_FIRST_TRANSACTION'
    REFERRAL_ACTION_REMINDER = 'REFERRAL_ACTION_REMINDER'
    REFERRAL_EVENT_TOP_UP = 'REFERRAL_EVENT_TOP_UP'
    REFERRAL_EVENT_CONVERSION = 'REFERRAL_EVENT_CONVERSION'
    REFERRAL_EVENT_SEND = 'REFERRAL_EVENT_SEND'
    REFERRAL_EVENT_PAYMENT = 'REFERRAL_EVENT_PAYMENT'
    REFERRAL_EVENT_P2P_TRADE = 'REFERRAL_EVENT_P2P_TRADE'
    REFERRAL_REWARD_READY = 'REFERRAL_REWARD_READY'
