...
/**
 * zkLogin input parser V2 - Based on circuit research
 * Improved base64 index calculation and field handling
 */
...
export function prepareZkLoginInputs(
    ...
    const nonceValueIndex = findSubstringIndex(payloadStr, nonce) - nonceColonIndex;
    ...
    const extNonce = stringToAsciiArray(nonce, 44);  
