# Generated migration to fix unified view - remove id column
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('usdc_transactions', '0002_create_unified_usdc_transactions_view'),
    ]

    operations = [
        # First drop the existing view
        migrations.RunSQL(
            sql="DROP VIEW IF EXISTS unified_usdc_transactions;",
            reverse_sql=""
        ),
        
        # Recreate with transaction_id as the primary identifier
        migrations.RunSQL(
            sql="""
