"""
Deploy ConfioInviteEscrow to BSC via the KMS sponsor.
...
Usage:
  ...
  myvenv/bin/python manage.py deploy_invite_escrow
...
class Command(BaseCommand):
    help = "Deploy ConfioInviteEscrow to BSC via the KMS sponsor"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("")
        self.stdout.write(f"invite escrow → {vault_addr}  (~{gas_est} gas, ≈ {total_cost/1e18:.6f} BNB)")
