// This is a partial file containing ONLY the corrected signInWithApple method
// Replace lines 426-707 in authService.ts with this content
  ...
  public async signInWithApple() {
    ...
    try {
      ...
      try {
        const localAccounts = await accountManager.getLocalAccounts();
