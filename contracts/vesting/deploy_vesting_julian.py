...
def deploy_julian_vesting():
    print("=== DEPLOYING JULIAN'S VESTING TO MAINNET ===")
    
    client = get_client()
    accounts = init_accounts()
    
    confio_id = int(os.getenv("ALGORAND_CONFIO_ASSET_ID"))
    duration = 94_608_000 # 36 months = 3 * 365 * 24 * 3600 (approx)
    # Actually user said "36 vesting months". 36 * 30 * 24 * 3600? Or 3 years?
    # Standard is usually 365 days years. 
    # Let's use 3 years = 3 * 31536000 = 94,608,000.
    
    funding_amount = 893_600_000_000_000 # 893,600,000 CONFIO * 10^6 decimals
    
    # Placeholder Beneficiary = Multisig Admin Address
    beneficiary = "MAI35ABWYNKUOW5QMESNZB3WDOFZ2XPHUXGBI4WNL6AI5XLBLF7IUVOYRI"
    ...
    print(f"Duration: {duration} seconds (36 months)")
    print(f"Funding: {funding_amount} microCONFIO (893.6M CONFIO)")
    ...
    print(f"Julian Vesting Deployed! App ID: {app_id}")
    ...
    # 3. Fund
    print(f"Funding Vault with 893,600,000 CONFIO...")
    sp = client.suggested_params()
    ...
    print(f"Use ALGORAND_VESTING_JULIAN_APP_ID={app_id}")
